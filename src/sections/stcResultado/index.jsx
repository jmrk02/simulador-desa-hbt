  ...
  return (
    <div className="stc-hbt-resutl-rent py-5" id="resultado">
      ...
      <div className="container">
        <div className="d-block box_general">
          <div className="row">
            ...
            <div className="container row box_resultado">
              <div className="header-pills d-flex align-items-center mb-4 justify-content-center"  style={{marginTop:'1rem'}}>
      ...
      <div className="container">
        ...
        <div >
          {/* el div de arriva es para la transicion */}
